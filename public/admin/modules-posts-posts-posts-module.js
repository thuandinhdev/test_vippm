...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".mg-t-1rem {\n  margin-top: 1rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var PostCreateComponent = /** @class */ (function () {
    ...
    PostCreateComponent.prototype.loadForm = function () {
        ...
        this.createPostForm = this.formBuilder.group({
            ...
            // compare_price: [null, Validators.required],
            // image: [null],
            seoData: this.formBuilder.array([]),
            seo: [null],
            collections: [null],
            // content: [null, Validators.required],
            // manufacturers: [null, Validators.required],
            properties: [null],
    ...
    PostCreateComponent.prototype.getVariations = function (data) {
        var price;
        var price_plus = 0;
        !this.createPostForm.get('price').value ? price = 0 : price = this.createPostForm.get('price').value;
        var variationsData = {};
        for (var i = 0; i < data.length; i++) {
            ...
            price_plus += data[i].price_plus;
        }
        variationsData['price'] = [price + price_plus];
        variationsData['price_plus'] = [price_plus];
        variationsData['image'] = [''];
    ...
    PostCreateComponent.prototype.onSubmit = function () {
        ...
        // if(this.acceptedFiles == '.stl'){
        this.createPostForm.patchValue({ avatar: this.selectedFiles });
        // }
    ...
    PostCreateComponent.prototype.loadDropzone = function (elementDropzone) {
        var that = this;
        var limitFile;
        elementDropzone == 'avatardropzone' && this.acceptedFiles != '.stl' ? limitFile = 1 : limitFile = 100;
        var myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_17__(this[elementDropzone].nativeElement, {
            ...
            init: function () {
                this.on('addedfile', function (file) {
                    ...
                    if (file) {
                        console.log(that.acceptedFiles);
                        var reader_1 = new FileReader();
                        if (elementDropzone == 'avatardropzone' && that.acceptedFiles != '.stl') {
                            ...
                            reader_1.onload = function (e) {
                                ...
                                console.log(that.selectedFiles);
                            };
                        }
    ...
    PostCreateComponent.prototype.dropzoneCallback = function (data) {
        var _a;
        var control = this.createPostForm.get('variations').at(data.parentFormGroupName);
        control.patchValue((_a = {},
            _a['image'] = data.file,
            _a));
    };
    PostCreateComponent.prototype.changePrice = function () {
        var _this_1 = this;
        var price = 0;
        !this.createPostForm.get('price').value ? price = 0 : price = this.createPostForm.get('price').value;
        this.controllVariations.controls.forEach(function (value, index) {
            var _a;
            var control = _this_1.createPostForm.get('variations').at(index);
            control.patchValue((_a = {},
                _a['price'] = price + _this_1.controllVariations.controls[index].value.price_plus,
                _a));
        });
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".ng-select.ng-select-single .ng-select-container {\n  min-width: 500px;\n}\n\n.inp {\n  border: none;\n  border-bottom: 1px solid #e8eef3;\n  padding: 5px 10px;\n  outline: none;\n  width: 100%;\n}\n\n[placeholder]:focus::-webkit-input-placeholder {\n  transition: text-indent 0.4s 0.4s ease;\n  text-indent: -100%;\n  opacity: 1;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var PostEditComponent = /** @class */ (function () {
    ...
    PostEditComponent.prototype.ngOnInit = function () {
        ...
        if (this.router.url.indexOf('/allnews/edit') !== -1) {
            ...
            if (this.router.url.indexOf('/food/edit') !== -1) {
                this.moduletype = 'food';
                this.urlPage = '/food';
                this.getOptions('manufacturers');
                this.getOptions('properties');
    ...
    PostEditComponent.prototype.loadForm = function () {
        ...
        this.editPostForm = this.formBuilder.group({
            ...
            // category: [this.post.po_cates_id, Validators.required],
            ...
            // manufacturers: [this.post.manufacturers, Validators.required],
            image: [this.post.image],
            // price: [this.post.price, Validators.required],
            // compare_price: [this.post.compare_price, Validators.required],
            removed_images: [[]],
            seoData: this.formBuilder.array([]),
            seo: [this.post.seo],
    ...
    PostEditComponent.prototype.onSubmit = function () {
        ...
        this.editPostForm.patchValue({ avatar: this.selectedFiles });
    ...
    PostEditComponent.prototype.removeDropzoneImage = function () {
        ...
        this.editPostForm.get('avatar').value ? this['avatardropzoneelement'].previewsContainer.lastChild['hidden'] = true : this['avatardropzoneelement'].previewsContainer.lastChild['hidden'] = false;
    };
    PostEditComponent.prototype.removeattachments = function (id) {
        ...
        if (this.acceptedFiles != '.stl') {
            ...
            (this.editPostForm.get('image').value.length == 0 && this.post.image.length == 0) ? this['imagedropzoneelement'].previewsContainer.lastChild['hidden'] = false : this['imagedropzoneelement'].previewsContainer.lastChild['hidden'] = true;
        }
        else {
            this.post.avatar.forEach(function (value, index) {
                if (value.id == id) {
                    _this_1.post.avatar.splice(index, 1);
                    _this_1.removedFiles.push(id);
                }
            });
            (this.editPostForm.get('avatar').value.length == 0 && this.post.avatar.length == 0) ? this['avatardropzoneelement'].previewsContainer.lastChild['hidden'] = false : this['avatardropzoneelement'].previewsContainer.lastChild['hidden'] = true;
        }
    };
    ...
    PostEditComponent.prototype.dropzoneCallback = function (data) {
        var _a;
        var control = this.editPostForm.get('variations').at(data.parentFormGroupName);
        control.patchValue((_a = {},
            _a['image'] = data.file,
            _a));
    };
    PostEditComponent.prototype.getVariations = function (data, LoadValues) {
        ...
        var price;
        var price_plus = 0;
        !this.editPostForm.get('price').value ? price = 0 : price = this.editPostForm.get('price').value;
        for (var i = 0; i < data.length; i++) {
            variationsData[data[i].options_indentify] = [data[i].indentify, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required];
        ...
        if (LoadValues && LoadValues.id && LoadValues.price) {
            variationsData['price'] = [price + price_plus];
            // variationsData['compare_price'] = [LoadValues.compare_price, [Validators.required, Validators.min(1)]];
            variationsData['id'] = [LoadValues.id];
            variationsData['sku'] = [LoadValues.sku];
            // variationsData['check'] = [LoadValues.status];
            variationsData['image'] = [LoadValues.image];
        }
        else {
            // variationsData['compare_price'] = ['', [Validators.required, Validators.min(1)]];
            variationsData['price'] = [price + price_plus];
            variationsData['price_plus'] = [price_plus];
            variationsData['image'] = [''];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".hide_empty_message ::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
    ...
    PostListsComponent.prototype.ngOnInit = function () {
        switch (this.router.url) {
            case "/allnews":
                ...
                break;
            case "/food":
                this.curentModule = 'food';
                this.moduletype = 'food';
                break;
            case "/cfd":
                this.curentModule = 'cfd';
                this.moduletype = 'cfd';
                break;
        }
        this.loadDatatable();

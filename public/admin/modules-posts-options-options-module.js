...
/* harmony import */ var _core_services_options_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../core/services/options.service */ "./src/app/core/services/options.service.ts");
...
var OptionsCreateComponent = /** @class */ (function () {
    ...
    OptionsCreateComponent.prototype.loadForms = function () {
        ...
        this.createSpecificationForm = this.formBuilder.group({
            ...
            avatar: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
    ...
    OptionsCreateComponent.prototype.addOption = function () {
        ...
        control.push(this.formBuilder.group({
            name: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            price_plus: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            check: [null]
        }));
    };
    ...
    OptionsCreateComponent.prototype.onSubmit = function () {
        ...
        this.optionsService.create(this.createSpecificationForm.value)
            ...
            _this_1.toastr.success(_this_1.optionsLang.messages.create, _this_1.optionsLang.title);
    ...
    OptionsCreateComponent.prototype.loadDropzone = function () {
        var that = this;
        this['fileDropZone'] = new dropzone__WEBPACK_IMPORTED_MODULE_8__(this.logodropzone.nativeElement, {
                ...
                this.on('addedfile', function (file) {
                    ...
                    if (file) {
                        ...
                        reader_1.onload = function (e) {
                            that.createSpecificationForm.patchValue({ avatar: reader_1.result });
    ...
    OptionsCreateComponent.prototype.removeDropzoneImage = function () {
    ...
    OptionsCreateComponent.ctorParameters = function () { return [
        ...
        { type: _core_services_options_service__WEBPACK_IMPORTED_MODULE_9__["OptionsService"] },
    ...
    ], OptionsCreateComponent.prototype, "logodropzone", void 0);
    OptionsCreateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"],
            ...
            _core_services_options_service__WEBPACK_IMPORTED_MODULE_9__["OptionsService"],
...
/* harmony import */ var _core_services_options_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../core/services/options.service */ "./src/app/core/services/options.service.ts");
...
var OptionsEditComponent = /** @class */ (function () {
    ...
    OptionsEditComponent.prototype.loadForms = function () {
        ...
        this.editOptionsForm = this.formBuilder.group({
            ...
            options: this.formBuilder.array([]),
            avatar: [this.options.avatar, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            status: [true, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
        for (var _i = 0, _a = this.options.options; _i < _a.length; _i++) {
            ...
            control.push(this.formBuilder.group({
                ...
                price_plus: [valueOption.price_plus, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
    ...
    OptionsEditComponent.prototype.onSubmit = function () {
        ...
        this.optionsService.update(this.editOptionsForm.value)
            .subscribe(function (data) {
            _this_1.toastr.success(_this_1.optionsLang.messages.update, _this_1.optionsLang.title);
            _this_1.event.emit({ data: true });
            _this_1.onCancel();
        });
    };
    ...
    OptionsEditComponent.prototype.loadDropzone = function () {
        var that = this;
        this['fileDropZone'] = new dropzone__WEBPACK_IMPORTED_MODULE_8__(this.logodropzone.nativeElement, {
            url: 'https://httpbin.org/post',
            maxFiles: 1,
            ...
            init: function () {
                ...
                this.on('addedfile', function (file) {
                    ...
                    if (file) {
                        var reader_1 = new FileReader();
                        reader_1.onload = function (e) {
                            that.editOptionsForm.patchValue({ avatar: reader_1.result });
                            _this_1.isLogoLoaded = false;
                        };
                        reader_1.readAsDataURL(file);
                    }
    ...
    OptionsEditComponent.prototype.removeDropzoneImage = function () {
        this.isLogoLoaded = false;
    ...
    OptionsEditComponent.ctorParameters = function () { return [
        ...
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: _core_services_options_service__WEBPACK_IMPORTED_MODULE_10__["OptionsService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"] },
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('logodropzone', { static: false }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
    ], OptionsEditComponent.prototype, "logodropzone", void 0);
    OptionsEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"],
            ...
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"],
            _core_services_options_service__WEBPACK_IMPORTED_MODULE_10__["OptionsService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"],

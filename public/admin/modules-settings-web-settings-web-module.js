...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/settings-web/components/control-content/control-content.component.html":
/*!**************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/modules/settings-web/components/control-content/control-content.component.html ***!
  \**************************************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<iframe src=\"http://localhost/web-food-demo/public/controlpage/control-page.html\" width=\"100%\" height=\"2000px\" id=\"control-page\"></iframe>\n<!-- <script>\n    var iframe = document.getElementsByTagName('control-page')[0],\n    iDoc = iframe.contentWindow     // sometimes glamorous naming of variable\n        || iframe.contentDocument;  // makes your code working :)\n    if (iDoc.document) {\n        iDoc = iDoc.document;\n        iDoc.body.addEventListener('afterLayout', function(){\n                            console.log('works');\n                    });\n    };\n</script> -->");
...
var PagesService = /** @class */ (function () {
    ...
    PagesService.prototype.buildControlPage = function () {
        return this.http.get(this.apiUrl + "/api/build-control-page");
    };
...
/***/ "./src/app/modules/settings-web/components/control-content/control-content.component.scss":
/*!************************************************************************************************!*\
  !*** ./src/app/modules/settings-web/components/control-content/control-content.component.scss ***!
  \************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/modules/settings-web/components/control-content/control-content.component.ts":
/*!**********************************************************************************************!*\
  !*** ./src/app/modules/settings-web/components/control-content/control-content.component.ts ***!
  \**********************************************************************************************/
/*! exports provided: ControlContentComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ControlContentComponent", function() { return ControlContentComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _core_services_pages_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../core/services/pages.service */ "./src/app/core/services/pages.service.ts");
...
var ControlContentComponent = /** @class */ (function () {
    function ControlContentComponent(translate, modalService, http, exportAsService, toastr, authenticationService, pagesService, helperService) {
        var _this = this;
        ...
        this.currentFrameUrl = "http://localhost/web-food-demo/public/controlpage/control-page.html";
        this.dataIframe = [];
        this.dtOptions = {};
        this.pages = [];
        this.exportAsConfig = {
        ...
        function callbackEditWidget(id) {
            alert(22222);
        }
    }
    ControlContentComponent.prototype.ngOnInit = function () {
        this.buildControlPages();
    };
    ControlContentComponent.prototype.buildControlPages = function () {
        var _this = this;
        this.pagesService.buildControlPage()
            .subscribe(function (resp) {
            _this.dataIframe = resp;
            // console.log(this.dataIframe[0]);
        });
    };
    ControlContentComponent.prototype.yourLoadFunction = function () {
    ...
    ControlContentComponent.ctorParameters = function () { return [
        ...
        { type: _core_services_pages_service__WEBPACK_IMPORTED_MODULE_9__["PagesService"] },
    ...
    ], ControlContentComponent.prototype, "dtElement", void 0);
    ControlContentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-control-content',
            template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./control-content.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/settings-web/components/control-content/control-content.component.html")).default,
            styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./control-content.component.scss */ "./src/app/modules/settings-web/components/control-content/control-content.component.scss")).default]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateService"],
            ...
            _core_services_pages_service__WEBPACK_IMPORTED_MODULE_9__["PagesService"],
            _core_services_helper_service__WEBPACK_IMPORTED_MODULE_10__["HelperService"]])
    ], ControlContentComponent);
    return ControlContentComponent;
}());
...
var ManagerWidgetsTypesCreateComponent = /** @class */ (function () {
    ...
    widgetsTypesService, helperService) {
        ...
        this.helperService = helperService;
        this.event = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.renderTypeData = this.translate.instant('settings_web.shared.renderTypeData');
        this.multiLanguageData = this.translate.instant('settings_web.shared.multiLanguageData');
        this.isFormSubmitted = false;
    ...
    ManagerWidgetsTypesCreateComponent.prototype.loadForms = function () {
        this.createManagerWidgetsTypesForm = this.formBuilder.group({
            ...
            multi_language: [0, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
...
var ManagerWidgetsTypesEditComponent = /** @class */ (function () {
    ...
    ManagerWidgetsTypesEditComponent.prototype.loadForms = function () {
        this.editManagerWidgetsTypesForm = this.formBuilder.group({
            ...
            multi_language: [this.managerWidgetTypes.multi_language, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            select_options: this.formBuilder.array([]),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n\n::ng-deep ngx-monaco-editor {\n  height: 400px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var TemplatesCreateComponent = /** @class */ (function () {
    ...
    TemplatesCreateComponent.prototype.loadForms = function () {
        this.createTemplatesForm = this.formBuilder.group({
            name: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            // folder: [null, [Validators.required, Validators.pattern(/^[a-z0-9]*$/)]],
            // content_html: [null, Validators.required],
            description: [null],
        });
    };
...
var TemplatesEditComponent = /** @class */ (function () {
    ...
    TemplatesEditComponent.prototype.onSubmit = function () {
        ...
        this.templatesService.update(this.editTemplatesForm.value)
            .subscribe(function (data) {
            _this.toastr.success(_this.translate.instant('settings_web.templates.messages.update'), _this.translate.instant('settings_web.templates.title'));
            _this.event.emit({ data: true });
            _this.onCancel();
        });
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep ngx-monaco-editor {\n  height: 400px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var WidgetsEditDataComponent = /** @class */ (function () {
    function WidgetsEditDataComponent(translate, bsModalRef, formBuilder, toastr, widgetsService, helperService, widgetsTypesService) {
        ...
        this.widgetsTypesService = widgetsTypesService;
        this.event = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.translations = this.translate.instant('settings_web.shared.translations');
        this.useData = [];
        this.isFormSubmitted = false;
        this.isPageLoaded = false;
        this.leftEcho = '{{';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n\n::ng-deep ngx-monaco-editor {\n  height: 400px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".hide_empty_message ::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".hide_empty_message ::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".hide_empty_message ::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".hide_empty_message ::ng-deep .odd {\n  display: none;\n}\n\n::ng-deep ngx-monaco-editor {\n  height: 400px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("@charset \"UTF-8\";\n/**\n * Nestable\n */\n.dd {\n  position: relative;\n  display: block;\n  margin: 0;\n  padding: 0;\n  max-width: 600px;\n  list-style: none;\n  font-size: 13px;\n  line-height: 20px;\n}\n.dd-list {\n  display: block;\n  position: relative;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n.dd-list .dd-list {\n  padding-left: 30px;\n}\n.dd-collapsed .dd-list {\n  display: none;\n}\n.dd-item,\n.dd-empty,\n.dd-placeholder {\n  display: block;\n  position: relative;\n  margin: 0;\n  padding: 0;\n  min-height: 20px;\n  font-size: 13px;\n  line-height: 20px;\n}\n.dd-handle {\n  display: block;\n  height: 30px;\n  margin: 5px 0;\n  padding: 5px 10px;\n  color: #333;\n  text-decoration: none;\n  font-weight: bold;\n  border: 1px solid #ccc;\n  background: #fafafa;\n  border-radius: 3px;\n  box-sizing: border-box;\n  -moz-box-sizing: border-box;\n}\n.dd-handle:hover {\n  color: #2ea8e5;\n  background: #fff;\n}\n.dd-item > button {\n  display: block;\n  position: relative;\n  cursor: pointer;\n  float: left;\n  width: 25px;\n  height: 20px;\n  margin: 5px 0;\n  padding: 0;\n  text-indent: 100%;\n  white-space: nowrap;\n  overflow: hidden;\n  border: 0;\n  background: transparent;\n  font-size: 12px;\n  line-height: 1;\n  text-align: center;\n  font-weight: bold;\n}\n.dd-item > button:before {\n  content: \"+\";\n  display: block;\n  position: absolute;\n  width: 100%;\n  text-align: center;\n  text-indent: 0;\n}\n.dd-item > button[data-action=collapse]:before {\n  content: \"-\";\n}\n.dd-placeholder,\n.dd-empty {\n  margin: 5px 0;\n  padding: 0;\n  min-height: 30px;\n  background: #f2fbff;\n  border: 1px dashed #b6bcbf;\n  box-sizing: border-box;\n  -moz-box-sizing: border-box;\n}\n.dd-empty {\n  border: 1px dashed #bbb;\n  min-height: 100px;\n  background-color: #e5e5e5;\n  background-image: linear-gradient(45deg, #fff 25%, transparent 25%, transparent 75%, #fff 75%, #fff), linear-gradient(45deg, #fff 25%, transparent 25%, transparent 75%, #fff 75%, #fff);\n  background-size: 60px 60px;\n  background-position: 0 0, 30px 30px;\n}\n.dd-dragel {\n  position: absolute;\n  pointer-events: none;\n  z-index: 9999;\n}\n.dd-dragel > .dd-item .dd-handle {\n  margin-top: 0;\n}\n.dd-dragel .dd-handle {\n  box-shadow: 2px 4px 6px 0 rgba(0, 0, 0, 0.1);\n}\n/**\n * Nestable Extras\n */\n.nestable-lists {\n  display: block;\n  clear: both;\n  padding: 30px 0;\n  width: 100%;\n  border: 0;\n  border-top: 2px solid #ddd;\n  border-bottom: 2px solid #ddd;\n}\n#nestable-menu {\n  padding: 0;\n  margin: 20px 0;\n}\n#nestable-output,\n#nestable2-output {\n  width: 100%;\n  height: 7em;\n  font-size: 0.75em;\n  line-height: 1.333333em;\n  font-family: Consolas, monospace;\n  padding: 5px;\n  box-sizing: border-box;\n  -moz-box-sizing: border-box;\n}\n#nestable2 .dd-handle {\n  color: #fff;\n  border: 1px solid #999;\n  background: #bbb;\n}\n#nestable2 .dd-handle:hover {\n  background: #bbb;\n}\n#nestable2 .dd-item > button:before {\n  color: #fff;\n}\n.dd-hover > .dd-handle {\n  background: #2ea8e5 !important;\n}\n/**\n * Nestable Draggable Handles\n */\n.dd3-content {\n  display: block;\n  height: 30px;\n  margin: 5px 0;\n  padding: 5px 10px 5px 40px;\n  color: #333;\n  text-decoration: none;\n  font-weight: bold;\n  border: 1px solid #ccc;\n  background: #fafafa;\n  border-radius: 3px;\n  box-sizing: border-box;\n  -moz-box-sizing: border-box;\n}\n.dd3-content:hover {\n  color: #2ea8e5;\n  background: #fff;\n}\n.dd-dragel > .dd3-item > .dd3-content {\n  margin: 0;\n}\n.dd3-item > button {\n  margin-left: 30px;\n}\n.dd3-handle {\n  position: absolute;\n  margin: 0;\n  left: 0;\n  top: 0;\n  cursor: pointer;\n  width: 30px;\n  text-indent: 100%;\n  white-space: nowrap;\n  overflow: hidden;\n  border: 1px solid #aaa;\n  background: #ddd;\n  border-top-right-radius: 0;\n  border-bottom-right-radius: 0;\n}\n.dd3-handle:before {\n  content: \"≡\";\n  display: block;\n  position: absolute;\n  left: 0;\n  top: 3px;\n  width: 100%;\n  text-align: center;\n  text-indent: 0;\n  color: #fff;\n  font-size: 20px;\n  font-weight: normal;\n}\n.dd3-handle:hover {\n  background: #ddd;\n}\n.disabled {\n  pointer-events: none;\n  opacity: 0.6;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _components_control_content_control_content_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./components/control-content/control-content.component */ "./src/app/modules/settings-web/components/control-content/control-content.component.ts");
/* harmony import */ var ngx_monaco_editor__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ngx-monaco-editor */ "./node_modules/ngx-monaco-editor/fesm5/ngx-monaco-editor.js");
/* harmony import */ var src_app_shared_components_light_bulb_light_bulb_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! src/app/shared/components/light-bulb/light-bulb.component */ "./src/app/shared/components/light-bulb/light-bulb.component.ts");
    ...
    SettingsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_control_content_control_content_component__WEBPACK_IMPORTED_MODULE_48__["ControlContentComponent"],
                ...
                src_app_shared_components_light_bulb_light_bulb_component__WEBPACK_IMPORTED_MODULE_50__["LightBulbComponent"]
            ],
            imports: [
                ...
                ngx_monaco_editor__WEBPACK_IMPORTED_MODULE_49__["MonacoEditorModule"].forRoot()
            ],
            entryComponents: [
                _components_regions_create_regions_create_component__WEBPACK_IMPORTED_MODULE_19__["RegionsCreateComponent"],
                _components_regions_edit_regions_edit_component__WEBPACK_IMPORTED_MODULE_20__["RegionsEditComponent"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".dropdown-menu {\n  left: -20px !important;\n  box-shadow: 2px 2px 5px 0px #d6c0d6;\n}\n\n.person-dropdown:after {\n  content: \"\";\n  position: absolute;\n  top: -7px;\n  left: 15px;\n  width: 14px;\n  height: 14px;\n  -ms-transform: rotate(-45deg);\n      transform: rotate(-45deg);\n  z-index: -1;\n  background: white;\n  border-right: 1px solid rgba(0, 0, 0, 0.15);\n  border-top: 1px solid rgba(0, 0, 0, 0.15);\n}\n\n.inline-block {\n  display: inline-block;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

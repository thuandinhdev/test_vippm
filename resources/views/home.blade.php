...
<head>
    ...
    <div class="container">
        <?php $logo= json_decode('{"file":"6237fa20b1693.png"}', true); $logo['multipleData'] = json_decode('[]', true); ?><div>
    <a class="logo" href="index.html">
        <img src="{{$file_path}}{{$logo['file']}}" height="24" alt="">
    </a>
</div><?php $menu= json_decode('[]', true); $menu['multipleData'] = json_decode('[]', true); ?><div class="menu-extras">
        <div class="menu-item">
            <!-- Mobile menu toggle-->
...
</header><?php $hero= json_decode('{"title1":"Our Creativity Is Your111","title2":"Success123456","description":"Launch your campaign and benefit from our expertise on designing and managing conversion centered bootstrap4 html page."}', true); $hero['multipleData'] = json_decode('[]', true); ?><!-- Hero Start -->
<section class="bg-half-170  d-table w-100" id="home">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-7">
                <div class="title-heading mt-4">
                    <h1 class="heading mb-3"> {{$hero['title1']}} <span class="text-primary">{{$hero['title2']}}</span> </h1>
                    <p class="para-desc text-muted">{{$hero['description']}}</p>
                    <div class="mt-4">
...
<!-- Hero End --><?php $partners= json_decode('[]', true); $partners['multipleData'] = json_decode('[]', true); ?><!-- Partners start -->

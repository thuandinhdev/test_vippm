...
<head>
        ...
        <!-- favicon -->
        <link rel="shortcut icon" href="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/favicon.ico">
        <!-- Bootstrap -->
        <link href="http://localhost/web-food-demo/public/../resources/themes/cfdfood/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- Icons -->
        <link href="http://localhost/web-food-demo/public/../resources/themes/cfdfood/css/materialdesignicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Slider -->               
        <link rel="stylesheet" href="http://localhost/web-food-demo/public/../resources/themes/cfdfood/css/owl.carousel.min.css"/> 
        <link rel="stylesheet" href="http://localhost/web-food-demo/public/../resources/themes/cfdfood/css/owl.theme.default.min.css"/>    
        <!-- Main Css -->
        <link href="http://localhost/web-food-demo/public/../resources/themes/cfdfood/css/style.css" rel="stylesheet" type="text/css" id="theme-opt" />
        <link href="http://localhost/web-food-demo/public/../resources/themes/cfdfood/css/colors/default.css" rel="stylesheet" id="color-opt">
    ...
    <div class="container">
        <?php $logo= json_decode('{"file":"6237fa20b1693.png"}', true); $logo['multipleData'] = json_decode('[]', true); ?><div onclick='callbackEditWidget(1)'><div>
    <a class="logo" href="index.html">
        <img src="http://localhost/web-food-demo/public/uploads/project/6237fa20b1693.png" height="24" alt="">
    </a>
</div></div><?php $menu= json_decode('[]', true); $menu['multipleData'] = json_decode('[]', true); ?><div onclick='callbackEditWidget(2)'><div class="menu-extras">
        <div class="menu-item">
            <!-- Mobile menu toggle-->
...
</header><?php $hero= json_decode('{"title1":"Our Creativity Is Your111","title2":"Success123456","description":"Launch your campaign and benefit from our expertise on designing and managing conversion centered bootstrap4 html page."}', true); $hero['multipleData'] = json_decode('[]', true); ?><div onclick='callbackEditWidget(3)'><!-- Hero Start -->
<section class="bg-half-170  d-table w-100" id="home">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-7">
                <div class="title-heading mt-4">
                    <h1 class="heading mb-3"> Our Creativity Is Your111 <span class="text-primary">Success123456</span> </h1>
            ...
            <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                <img src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/illustrator/Startup_SVG.svg" alt="">
            </div><!--end col-->
        </div><!--end row-->
    </div><!--end container-->
</section><!--end section-->
<!-- Hero End --></div><?php $partners= json_decode('[]', true); $partners['multipleData'] = json_decode('[]', true); ?><div onclick='callbackEditWidget(4)'><!-- Partners start -->
<section class="py-4 border-bottom border-top">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                <img src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/client/amazon.svg" class="avatar avatar-ex-sm" alt="">
            </div><!--end col-->

            <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                <img src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/client/google.svg" class="avatar avatar-ex-sm" alt="">
            </div><!--end col-->
            
            <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                <img src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/client/lenovo.svg" class="avatar avatar-ex-sm" alt="">
            </div><!--end col-->
            
            <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                <img src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/client/paypal.svg" class="avatar avatar-ex-sm" alt="">
            </div><!--end col-->
            
            <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                <img src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/client/shopify.svg" class="avatar avatar-ex-sm" alt="">
            </div><!--end col-->
            
            <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                <img src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/images/client/spotify.svg" class="avatar avatar-ex-sm" alt="">
            </div><!--end col-->
        </div><!--end row-->
    </div><!--end container-->
</section><!--end section-->
<!-- Partners End --></div><script type="text/javascript"> function callbackEditWidget(id) { window.parent.postMessage(id, "*"); } </script>
    <!-- Start Style switcher -->
    <div id="style-switcher" style="left: 0px;" class="bg-light border p-3 pt-2 pb-2"  resource_path="http://localhost/web-food-demo/public/../resources/themes/cfdfood/">
    ...
    <!-- javascript -->
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/jquery-3.5.1.min.js"></script>
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/bootstrap.bundle.min.js"></script>
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/jquery.easing.min.js"></script>
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/scrollspy.min.js"></script>
    <!-- SLIDER -->
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/owl.carousel.min.js"></script>
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/owl.init.js"></script>
    <!-- Icons -->
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/feather.min.js"></script>
    <!-- Switcher -->
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/switcher.js"></script>
    <!-- Main Js -->
    <script src="http://localhost/web-food-demo/public/../resources/themes/cfdfood/js/app.js"></script>
</body>
